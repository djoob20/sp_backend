...
}).AddCookie(x => { x.Cookie.Name = "token"; }).AddJwtBearer(x =>
{
    ...
    x.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        IssuerSigningKey =
            new SymmetricSecurityKey(Encoding.UTF8.GetBytes(builder.Configuration["Google:google-secret"])),
...
//Angular CORS
builder.Services.AddCors(options => options.AddPolicy("FrontendUI",
